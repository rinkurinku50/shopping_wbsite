...
var itemQuantity = document.getElementById('itemQu');
var itemCat = document.getElementById('cata'); //size row

var sizeRow = document.getElementById('sizeRow');
var smset = document.getElementById('smset');
var mdset = document.getElementById('mdset');
var lset = document.getElementById('lset');
var xlset = document.getElementById('xlset');
var xxlset = document.getElementById('xxlset'); //size

var sSize = document.getElementById('sSize');
var mSize = document.getElementById('mSize');
var lSize = document.getElementById('lSize');
var xlSize = document.getElementById('xlSize');
var xxlSize = document.getElementById('xxlSize'); //checkbox smallSize listener

sSize.addEventListener('change', function (e) {
...
mSize.addEventListener('change', function (e) {
...
lSize.addEventListener('change', function (e) {
...
xlSize.addEventListener('change', function (e) {
...
xxlSize.addEventListener('change', function (e) {
...
document.querySelector('#itemBu').addEventListener('click', function (e) {
  var smallVal = document.querySelector('#smallVal');
  var mediumVal = document.getElementById('mediumVal');
  var largeVal = document.getElementById('largeVal');
  var xlargeVal = document.getElementById('xlargeVal');
  var xxlargeVal = document.getElementById('xxlargeVal');
  var s = 0;
  var m = 0;
  var l = 0;
  var xl = 0;
  ...
  if (sSize.checked == false && mSize.checked == false && lSize.checked == false && xlSize.checked == false && xxlSize.checked == false) {
    new noty__WEBPACK_IMPORTED_MODULE_0___default.a({
      type: 'error',
  ...
  console.log(l);
  console.log(xl);
  console.log(xxl); ///main code from here
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/itemAdd', data).then(function (res) {
...
__webpack_require__(/*! D:\A_work\main\node\new\test\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\A_work\main\node\new\test\resources\scss\app.scss */"./resources/scss/app.scss");
